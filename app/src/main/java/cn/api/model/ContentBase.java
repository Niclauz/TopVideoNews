...
public class ContentBase implements Serializable {
    ...
    private String title1 = "";//内容名字
    private String title2 = "";
    private int typeMedia = 0;//内容格式 音频or视频  jc.content.util 包 有工具类
    private int typePattern = 0;//内容形式
    private int typeSize = 0;//内容大小
    private int type1 = 0;
    private int type2 = 0;
    private String typeList = "";//抓取内容原分类
    private String area1 = "";
    private String area2 = "";
    private String detail = "";
    private String tag = "";
    private int playMethod = 0;
    private String playStreaming = "";//播放流
