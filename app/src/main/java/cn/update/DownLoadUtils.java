...
/**
 * ��װ DownLoadManager ���� Created by Song on 2016/11/2.
 */
public class DownLoadUtils {
	...
	public long download(String uri, String title, String description, String appName) {
		...
		/**
		 * �������ϣ�����ص��ļ����Ա�ϵͳ��DownloadsӦ��ɨ�赽������
		 * ������Ҫ����Request�����setVisibleInDownloadsUi���������ݲ���true.
		 */
		...
		return mDownloadManager.enqueue(downloadRequest);// �첽����
	}
