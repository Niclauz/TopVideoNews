...
/** 评论和赞功能的演示页面 */
public class SocialActivity extends AppCompatActivity implements Callback, OnClickListener {
	// 模拟的主题id
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = SocialActivity.this;
		ShareSDK.initSDK(this);
		ShareSDK.registerService(Socialization.class);

		new Thread() {
			public void run() {
				UIHandler.sendEmptyMessageDelayed(INIT_SDK, 100, SocialActivity.this);
			}
		}.start();
		...
		Socialization.setLikeListener(new LikeListener() {
			...
			public void onSuccess(String topicId, String topicTitle, String commentId) {
				...
				msg.what = AFTER_LIKE;
				msg.arg1 = 1;
				UIHandler.sendMessage(msg, SocialActivity.this);
			}
